...
const Card = ({
  ...
  return (
    <div className="bg-white p-3 rounded-2xl border border-gray-100 shadow-sm flex flex-row justify-between items-center w-full h-full grid-cols-1 sm:grid-cols-1">
